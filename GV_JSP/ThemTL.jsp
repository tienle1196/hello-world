...
<div id="main">     
	...
	<div id="content" style="border:0px;margin-left:20px;width:1055px" >
		<h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Thêm Tài Liệu Học Tập</h4>
		<form method="post" action="#">
			<div class="form-inline">
				<label class="fieldinput col-md-3">Mã Lớp: </label>
				<input type="text" class="form-control">
			</div><br>	
			
			<div class="form-inline">
				<label class="col-md-3" for="exampleInputFile">Tải lên tài liệu: </label>
				<input type="file" id="InputFile">
			</div><br>

			<div class="form-inline">
				<label class="fieldinput col-md-3">Nội dung: </label>
