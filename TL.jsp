...
<div id="main">     
	...
	<div id="content" style="border:0px;margin-left:20px;width:1055px" >
		<h4 align="Center" style="background-color:#8258FA;color:white;line-height:40px;font-size:17px">Tài Liệu Học Tập</h4>
		<div class="btn-group">
			<button type="button"><a href="ThemTL.jsp">Thêm Tài Liệu Học Tập</a></button>
		</div>
		<table class="table" align="center">
			...
			<tbody>
				<tr>
					...
					<td><a href="ChiTietTL.jsp">Xem chi tiết</a></td>
				</tr>
				<tr>
					<td>2</td>
					<td>141111</td>
